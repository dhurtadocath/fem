...
static emlrtRSInfo emlrtRSI =
    {
        ...
        "/home/diego/fem/Matlab_Ill/IndentSphere_dS/fnctns/"
...
static int32_T b_binary_expand_op(real_T in1_data[], const real_T in2[729],
                                  const int32_T in3_data[],
                                  const int32_T *in3_size,
                                  const real_T in4_data[],
                                  const int32_T *in4_size);

static int32_T binary_expand_op(real_T in1_data[], const real_T in2[729],
                                const real_T in3[729], const int16_T in4_data[],
                                const int32_T *in4_size,
...
static real_T
mf_with_constr(const emlrtStack *sp, const real_T u[729], const real_T X[729],
               const real_T conn[740], const real_T free_ind_data[],
               ...
               const real_T slaves[222], const real_T dofs[729],
               const real_T s[444], const real_T sh[444], real_T f[729]);
               ...
               const real_T s[444], const real_T sh[444], real_T f[729])
{
  ...
  for (i = 0; i < 370; i++) {
    ...
    if (((int32_T)dofi_tmp_tmp < 1) || ((int32_T)dofi_tmp_tmp > 243)) {
      emlrtDynamicBoundsCheckR2012b((int32_T)dofi_tmp_tmp, 1, 243, &b_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  for (b_i = 0; b_i < 3; b_i++) {
    for (ib_size = 0; ib_size < 222; ib_size++) {
      d = slaves[ib_size];
      if (d != (int32_T)muDoubleScalarFloor(d)) {
        emlrtIntegerCheckR2012b(d, &c_emlrtDCI, (emlrtConstCTX)sp);
      }
      if (((int32_T)d < 1) || ((int32_T)d > 243)) {
        emlrtDynamicBoundsCheckR2012b((int32_T)d, 1, 243, &d_emlrtBCI,
                                      (emlrtConstCTX)sp);
      }
      i = ((int32_T)d + 243 * b_i) - 1;
      d = dofs[i];
      if (d != (int32_T)muDoubleScalarFloor(d)) {
      ...
      xs[ib_size + 222 * b_i] = X[i] + u[(int32_T)d - 1];
    }
  }
  ...
  for (i_cnstr = 0; i_cnstr < b_i; i_cnstr++) {
    ...
    if (y) {
      ...
      /*  phi = pi*s(cnt_act,1); */
      k = 3.1415926535897931 * (1.0 - s[i + 221]);
    ...
    if (((int32_T)k < 1) || ((int32_T)k > 729)) {
      emlrtDynamicBoundsCheckR2012b((int32_T)k, 1, 729, &g_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    ...
    if (((int32_T)phi < 1) || ((int32_T)phi > 729)) {
      emlrtDynamicBoundsCheckR2012b((int32_T)phi, 1, 729, &g_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    ...
    if (((int32_T)dofi_tmp_tmp < 1) || ((int32_T)dofi_tmp_tmp > 729)) {
      emlrtDynamicBoundsCheckR2012b((int32_T)dofi_tmp_tmp, 1, 729, &g_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
                            ...
                            const real_T sh[444], real_T *m_new, real_T *iter)
{
  ...
  emxArray_real_T *y;
  real_T d_tmp_data[729];
  real_T e_tmp_data[729];
  real_T f[729];
  real_T f_2_data[729];
  real_T f_3_data[729];
  ...
  *m_new = mf_with_constr(&st, u, X, conn, free_ind_data, trueCount,
  ...
  for (i = 0; i < trueCount; i++) {
    ...
    if (((int32_T)scalar2 < 1) || ((int32_T)scalar2 > 729)) {
      emlrtDynamicBoundsCheckR2012b((int32_T)scalar2, 1, 729, &h_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
  ...
  do {
    ...
    if ((c_norm(f_old_data, trueCount) > 0.0) &&
      ...
      if (*iter == 1.0) {
        ...
        b_f_old_data.allocatedSize = 729;
        ...
        c_f_old_data.allocatedSize = 729;
        ...
        d_f_old_data.allocatedSize = 729;
        ...
        e_f_old_data.allocatedSize = 729;
        ...
        f_f_old_data.allocatedSize = 729;
        ...
        g_f_old_data.allocatedSize = 729;
        ...
        h_f_old_data.allocatedSize = 729;
        ...
        i_f_old_data.allocatedSize = 729;
        ...
        j_f_old_data.allocatedSize = 729;
        ...
        k_f_old_data.allocatedSize = 729;
        ...
        l_f_old_data.allocatedSize = 729;
        ...
        m_f_old_data.allocatedSize = 729;
