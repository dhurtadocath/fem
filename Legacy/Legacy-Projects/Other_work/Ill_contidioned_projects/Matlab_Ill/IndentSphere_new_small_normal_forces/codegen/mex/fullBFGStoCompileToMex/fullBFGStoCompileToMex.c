...
static emlrtRSInfo emlrtRSI = {
    ...
    "/home/diego/fem/Matlab_Ill/IndentSphere_new_small_normal_forces/fnctns/"
...
static emlrtRSInfo gc_emlrtRSI = {
    19,        /* lineNo */
    "setdiff", /* fcnName */
    "/usr/local/MATLAB/R2024a/toolbox/eml/lib/matlab/ops/setdiff.m" /* pathName
                                                                     */
};
...
static emlrtRSInfo hc_emlrtRSI =
    {
        97,          /* lineNo */
        "eml_setop", /* fcnName */
        "/usr/local/MATLAB/R2024a/toolbox/eml/lib/matlab/ops/private/"
...
static int32_T binary_expand_op_5(real_T in1_data[], const real_T in2[570],
               ...
               const real_T s[304], const real_T sh[304], real_T f[570])
{
  ...
  for (i_cnstr = 0; i_cnstr < b_i; i_cnstr++) {
    ...
    boolean_T y;
    if (i_cnstr + 1 > b_i) {
      emlrtDynamicBoundsCheckR2012b(i_cnstr + 1, 1, b_i, &c_emlrtBCI,
                                    (emlrtConstCTX)sp);
    }
    /*  % Fless case */
    /*  g =norm(xsi - Cxy) - R; */
...
void fullBFGStoCompileToMex(const emlrtStack *sp, real_T u[570],
                            ...
                            const real_T sh[304], real_T *m_new, real_T *normF,
                            real_T *iter)
{
  emlrtStack b_st;
  emlrtStack st;
  ...
  *iter = 0.0;
  ...
  do {
    ...
    if ((c_norm(f_old_data, trueCount) > 0.0) &&
      ...
      for (i = 0; i < trueCount; i++) {
        f_old_data[i] = f_new_data[i];
        f_new_data[i] = f_2_data[i];
      }
      ...
      if (*iter == 1.0) {
        ...
        for (i = 0; i < signal2; i++) {
          ...
          for (i1 = partialTrueCount; i1 < signal1; i1++) {
        ...
        if ((product2->size[0] == product3->size[0]) &&
          ...
          st.site = &md_emlrtRSI;
          binary_expand_op_6(&st, product2, product3, scalar2);
          delta_u_data = product2->data;
        }
      ...
      if (trueCount == f_old_size) {
        ...
        partialTrueCount = binary_expand_op_5(
  ...
  /*  sprintf('fullBFGS: %s iter, %s subtiers',int2str(iter),int2str(iter2)) */
  *normF = c_norm(f_2_data, trueCount);
  /*  fprint('iters: %d') */
  emlrtHeapReferenceStackLeaveFcnR2012b((emlrtConstCTX)sp);
}
